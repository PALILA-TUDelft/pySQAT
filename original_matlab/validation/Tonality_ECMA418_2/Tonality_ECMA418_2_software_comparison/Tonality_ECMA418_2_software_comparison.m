...
pathAvgSpec = [ref_path AvgSpec_fileName];
pathTDep = [ref_path TDep_fileName];
pathSpec_TDep_channel_1 = [ref_path Spec_TDep_fileName_channel_1];
pathSpec_TDep_channel_2 = [ref_path Spec_TDep_fileName_channel_2];
ref_results.AvgSpec = readmatrix(pathAvgSpec, 'FileType', 'text');
ref_results.TDep = readmatrix(pathTDep, 'FileType', 'text');
ref_results.Spec_TDep_channel_1 = readmatrix(pathSpec_TDep_channel_1, 'FileType', 'text');
ref_results.Spec_TDep_channel_2 = readmatrix(pathSpec_TDep_channel_2, 'FileType', 'text');
